...
<head>
  ...
  <!-- Favicon -->
  <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('adminasset/img/63831460-money-wallet-icon-business-investment-concept-flat-vector-illustration.jpg')}}">
